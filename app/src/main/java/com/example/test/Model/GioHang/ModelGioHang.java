package com.example.test.Model.GioHang;
...
public class ModelGioHang {
    ...
    public boolean DeleteSanPhamTrongGioHang(int masp){
    ...
    public boolean UpdateSoLuongSanPhamGioHang(int masp,int soluong){
